...
class RandomSignInitializer(PerturbationInitializer):
    """
    RandomSignInitializer is a PerturbationInitializer that adds random noise to the input.
    The noise is sampled from a normal distribution and then the sign operator is applied.
    """
